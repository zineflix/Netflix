...
async function fetchBanner() {
    ...
    // Fetch genres (movie genres only)
...
fetchBanner();
fetchMedia(
    `${baseURL}/discover/movie?api_key=${apiKey}&language=en-US&sort_by=primary_release_date.desc&primary_release_year=${currentYear}&vote_count.gte=10`,
    "new-releases",
    "movie",
    5
);
